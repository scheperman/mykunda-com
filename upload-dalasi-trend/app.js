...
function payFooterHTML(){
  return `<div class="fb-pay"><div class="wrap fb-pay-in">
      <div class="fp-label">Ways to pay on MyKunda</div>
        ${payChipsHTML()}
        <p class="fp-note">Payments are processed by <b>Modem Pay</b>, licensed by the Central Bank of The Gambia as a payment aggregator (Reg. No. 2025/C25067). Mobile money and card payments are confirmed by the payment provider; bank transfers clear once the banks release them. MyKunda only collects listing and service fees — <b>we never take deposits, down payments or purchase money</b>. Those are always paid into the escrow account of your lawyer or notary.</p>
