...
(function () {
  ...
  var GROUPS = [
    ...
    },
    {
      ...
      items: function (T) {
        return [
          { name: 'Automatisch antwoord op WhatsApp', to: 'de afzender', trigger: 'Binnenkomend WhatsApp-bericht op +220 87 272 0268', subject: 'Platte tekst — WhatsApp kent geen opmaak', badge: 'nieuw', wa: T.whatsappAutoReply('Fatou Njie') },
