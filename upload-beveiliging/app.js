...
window.mapTilerUrl = function(style, ext){
  return 'https://api.maptiler.com/maps/' + (style || 'hybrid') +
         '/{z}/{x}/{y}.' + (ext || 'jpg') + '?key=' + window.MAPTILER_KEY;
};
...
const LISTINGS = [
  { id:'pr1', cat:'villa', type:'sale', isNew:true, verified:true, price:395000, title:'Beachfront Villa with Pool', street:'Palma Rima Road', area:'Kololi · Kombo North', beds:4, baths:3, sqm:320, plot:1000, tag:'Private pool', photos:28, x:52, y:46, lat:13.4520, lng:-16.7195,
    img:'images/kololi.webp' },
  { id:'pr2', cat:'apartment', type:'rent', price:850, title:'Sea-View Apartment', street:'Kotu Beach Road', area:'Kotu · Kombo St Mary', beds:2, baths:2, sqm:95, tag:'Sea view', photos:18, x:50, y:36, lat:13.4625, lng:-16.7010,
    img:'images/kotu.webp' },
  { id:'pr3', cat:'villa', type:'sale', verified:true, price:385000, title:'Gated Estate Villa', street:'Brufut Heights Estate', area:'Brufut · Kombo South', beds:5, baths:4, sqm:410, plot:1000, tag:'Pool · gated', photos:34, x:60, y:62, lat:13.4000, lng:-16.7590,
    img:'images/brufut-street.webp' },
  { id:'pr4', cat:'apartment', type:'rent', isNew:true, price:600, title:'Furnished Studio, Senegambia', street:'Senegambia Strip', area:'Senegambia · Kombo North', beds:1, baths:1, sqm:48, tag:'Furnished', photos:14, x:48, y:49, lat:13.4468, lng:-16.7148,
    img:'images/kololi.webp' },
  { id:'pr5', cat:'compound', type:'sale', verified:true, price:225000, title:'Family Compound', street:'Off Bertil Harding Highway', area:'Bijilo · Kombo North', beds:4, baths:3, sqm:280, plot:900, tag:'Gated', photos:22, x:55, y:54, lat:13.4181, lng:-16.7275,
    img:'images/bijilo.webp' },
  { id:'pr6', cat:'penthouse', type:'sale', price:265000, title:'Sea-View Penthouse', street:'Atlantic Road, Cape Point', area:'Cape Point · Kombo St Mary', beds:3, baths:3, sqm:210, tag:'Sea view', photos:26, x:47, y:20, lat:13.4880, lng:-16.6640,
    img:'images/capepoint.webp' },
  { id:'pr7', cat:'land', type:'sale', isNew:true, price:48000, title:'Beachfront Building Plot', street:'Sanyang Beach', area:'Sanyang · Kombo South', beds:0, baths:0, sqm:0, plot:1200, tag:'Beachfront', photos:9, x:49, y:82, lat:13.3760, lng:-16.7715,
    img:'images/sanyang.webp' },
  { id:'pr8', cat:'townhouse', type:'sale', verified:true, price:98000, title:'New-Build Townhouse', street:'Brusubi Phase 2', area:'Brusubi · Kombo North', beds:3, baths:2, sqm:175, plot:300, tag:'New build', photos:20, x:66, y:50, lat:13.4200, lng:-16.7280,
    img:'images/brusubi.webp' },
  { id:'pr9', cat:'lodge', type:'sale', price:420000, title:'Riverside Eco Lodge', street:'Kartong Riverside', area:'Kartong · Kombo South', beds:8, baths:8, sqm:540, plot:3000, tag:'Riverfront', photos:38, x:48, y:95, lat:13.0770, lng:-16.7160,
    img:'images/river-gambia.webp' },
];
...
const PRICING = {
  ...
  driftTolerance: 0.08,       // re-round once the rate has moved this far
  /* Ownership Verification — a stand-alone product a BUYER orders for any
     ...
     Document Check sits just under one month's average salary; the Full
     Check stays below 1% of any coastal property. */
  ownership: {
    standard: { gmd: 7500,  eur: 88 },
    full:     { gmd: 25000, eur: 293 }
  },
...
function planPriceFor(plan, askingGMD, deal){
  if(plan === 'promoted') return PRICING.promoted.gmd;
...
function pricingReviewDue(){
  ...
  return Math.abs(pricingDrift()) > PRICING.driftTolerance || months > 12;
}
...
function onRatesUpdated(){
  ...
  document.querySelectorAll('[data-ccy-cross]').forEach(function(el){
    ...
    el.textContent = '= D' + Math.round(CURRENCIES.GMD.rate / CURRENCIES[k].rate).toLocaleString();
  });
...
const AREA_COORDS = {
  'Kololi':[13.4500,-16.7167],'Kotu':[13.4580,-16.6930],'Brufut':[13.3842,-16.7514],'Bijilo':[13.4181,-16.7300],
  'Cape Point':[13.4849,-16.6661],'Cape Point, Bakau':[13.4849,-16.6661],'Bakau':[13.4781,-16.6819],'Brusubi':[13.4280,-16.7050],
  ...
  'Brikama':[13.2714,-16.6506],'Batokunku':[13.3233,-16.8008],'Gunjur':[13.1786,-16.7594],'Sambuya':[13.2131,-16.7656],
  'Basse':[13.3092,-14.2192],'Soma':[13.4333,-15.5333],
  'Barra':[13.4828,-16.5456],'Farafenni':[13.5670,-15.6010],
'Kanifing':[13.45,-16.6667],'Faji Kunda':[13.41778,-16.66667],'Talinding':[13.42558,-16.67261],'Bundung':[13.445,-16.66],'Latri Kunda':[13.437,-16.674],'Pipeline':[13.448,-16.662],'Bakoteh':[13.442,-16.678],'Tabokoto':[13.45,-16.6667],'New Jeshwang':[13.46,-16.664],'Old Jeshwang':[13.463,-16.658],'Dippa Kunda':[13.432,-16.665],'Ebou Town':[13.436,-16.675],'Abuko':[13.4042,-16.6558],'Churchills Town':[13.455,-16.655],'Sinchu Alagie':[13.42,-16.65],'Ebo Town':[13.438,-16.673],'Manjai Kunda':[13.45,-16.65],'Tallinding Kunjang':[13.437,-16.683],'Sukuta':[13.41033,-16.70815],'Lamin':[13.3858,-16.6428],'Brufut Heights':[13.4,-16.759],'Nema Kunku':[13.39,-16.72],'Yundum':[13.34556,-16.67278],'Banjulunding':[13.3667,-16.6833],'Busumbala':[13.33917,-16.6875],'Bwiam':[13.23528,-16.08639],'Sibanor':[13.3167,-16.4333],'Kafuta':[13.2333,-16.5667],'Somita':[13.20583,-16.30556],'Marakissa':[13.32,-16.68],'Pirang':[13.2725,-16.5353],'Faraba Banta':[13.2667,-16.5167],'Nyambai':[13.31,-16.66],'Jambur':[13.38,-16.73],'Tujereng':[13.31889,-16.78548],'Ghana Town':[13.38444,-16.77111],'Wellingara':[13.404,-16.674],'Jabang':[13.395,-16.675],'Sifoe':[13.18361,-16.6975],'Old Yundum':[13.3625,-16.68611],'Sinchu Baliya':[13.36,-16.66],'Berending (Kombo)':[13.34,-16.745],'Kitty':[13.32,-16.73],'Mandinaba':[13.34,-16.67],'Bonto':[13.29,-16.65],'Darsilami':[13.21,-16.48],'Mandina Ba':[13.24,-16.51],'Kembujeh':[13.37,-16.71],'Kerr Serign':[13.43247,-16.7203],'Madiana':[13.3533,-16.7631],'Berefet':[13.32,-16.55],'Bondali':[13.33,-16.63],'Bakindick':[13.26,-16.54],'Bambali':[13.23,-16.57],'Bulok':[13.1767,-16.4158],'Brifu':[13.21,-16.56],'Essau':[13.48389,-16.53472],'Kerewan':[13.4898,-16.08879],'Selik
ta':[13.5833,-14.7667],'Sambang':[13.6,-14.7333],'Demba Kunda':[13.35,-14.0833],'Sutukoba':[13.4167,-14],'Diabugu':[13.2667,-14.1167],'Chamoi':[13.35,-14.5167],'Kaiaf Niji':[13.5,-16.35],'Fass':[13.52,-16.25],'Jiffarong':[13.37,-15.77],'Dankunku':[13.5,-15.08],'Nianija':[13.55,-14.95],'Basse Mansajang':[13.32,-14.22],'Numuyel':[13.35,-14.15],'Konteh Kunda':[13.38,-14.05]
};
...
/* When the backend is live and has data, show ONLY real listings.
   Demo data (LISTINGS) is used only when the backend is offline. */
function allListings(){
  const db = getDbCache();
  const user = getUserListings();
  if(typeof backendReady==='function' && backendReady() && db.length > 0){
    return [...db, ...user];
  }
  return [...db, ...user, ...LISTINGS];
}
function isDemoMode(){ return !(typeof backendReady==='function' && backendReady() && getDbCache().length>0); }
...
const GUIDES = [
  { slug:'buying-property-in-the-gambia-as-a-foreigner', cat:'Buying', mins:6, date:'2026-06-10',
  ...
  { slug:'freehold-leasehold-customary-land-explained', cat:'Land & title', mins:5, date:'2026-06-08',
  ...
  { slug:'cost-of-buying-property-in-the-gambia', cat:'Buying', mins:5, date:'2026-06-05',
  ...
  { slug:'best-areas-to-buy-on-the-gambian-coast', cat:'Areas', mins:7, date:'2026-06-01',
  ...
  { slug:'bank-mortgages-in-the-gambia', cat:'Buying', mins:6, date:'2026-06-25',
  ...
  { slug:'developer-financing-in-the-gambia', cat:'Buying', mins:7, date:'2026-06-25',
  ...
  { slug:'how-to-verify-land-title-in-the-gambia', cat:'Land & title', mins:10, date:'2026-08-10',
...
function payFooterHTML(){
  return `<div class="wrap footer-pay">
      <div class="fp-label">Ways to pay on MyKunda</div>
      ${payChipsHTML()}
      <div class="fp-note">Payments are processed by <b>Modem Pay</b>, licensed by the Central Bank of The Gambia as a payment aggregator (Reg. No. 2025/C25067). Mobile money and card payments are confirmed by the payment provider; bank transfers clear once the banks release them. MyKunda only collects listing and service fees — <b>we never take deposits, down payments or purchase money</b>. Those are always paid into the escrow account of your lawyer or notary.</div>
    </div>`;
}
...
function headerHTML(active, onHero){
  ...
  const ccyPicker = `<div class="ccy-picker" id="ccyPicker">
      ...
      <div class="ccy-menu" id="ccyMenu">${Object.keys(CURRENCIES).map(k=>{
        ...
        if(k!=='GMD'){
          ...
          label += ' <span data-ccy-cross="'+k+'" style="opacity:.55;font-size:11px;white-space:nowrap">= D'+Math.round(gmdRate).toLocaleString()+'</span>';
        }
        ...
        ${links.map(l=>{
          ...
          if(l[0]==='Guides'){
            ...
            return `<div class="nav-dd">
              ...
              <div class="nav-dd-menu nav-dd-guides">${guideCats.map(c=>`<div class="nav-dd-region"><div class="nav-dd-region-title">${c}</div>${GUIDES.filter(g=>g.cat===c).map(g=>`<a href="guide.html?slug=${g.slug}">${g.title}</a>`).join('')}</div>`).join('')}<div class="nav-dd-footer"><a href="guides.html" class="nav-dd-all">All guides →</a></div></div>
            </div>`;
          }
          if(l[0]==='Verify'){
  ...
  <div class="hdr-search" id="hdrSearch" hidden>
    <div class="wrap hdr-search-inner">
      ...
      <input type="text" id="hdrSearchInput" placeholder="Search by area or town — Kololi, Brufut, Cape Point…">
      ...
      <nav class="md-nav">
        ${links.map(l=>{
          ...
          if(l[0]==='Guides'){
            ...
            <div class="md-areas-sub">${guideCats.map(c=>`<div style="padding:10px 0 4px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--muted)">${c}</div>${GUIDES.filter(g=>g.cat===c).map(g=>`<a href="guide.html?slug=${g.slug}">${g.title}</a>`).join('')}`).join('')}<a href="guides.html" style="margin-top:8px;font-weight:700;color:var(--green-700)">All guides →</a></div>`;
          }
          if(l[0]==='Verify'){
...
function footerHTML(){
  const cols = [
    ['Explore',['Properties for sale','Properties for rent','Land & plots','Area guides','New developments','Market index']],
  ...
  <footer class="site-footer">
    <div class="wrap footer-top">
      ...
      ${cols.map(c=>`<div class="footer-col"><h5>${c[0]}</h5>${c[1].map(a=>{const map={'Partner agents':'agent.html','Area guides':'kololi.html','Buyer\u2019s guide':'guide.html?slug=cost-of-buying-property-in-the-gambia','Ownership check':'verify.html','Diaspora & investor guide':'guide.html?slug=buying-property-in-the-gambia-as-a-foreigner','Properties for sale':'search.html?type=sale','Properties for rent':'search.html?type=rent','Land & plots':'search.html?type=sale&cat=land','New developments':'search.html?type=sale&feat=new','Market index':'market.html','Value my property':'sell.html#value','Saved searches':'dashboard.html','Favorites':'dashboard.html','About MyKunda':'about.html','Contact':'contact.html','FAQ':'faq.html','Safe & supported':'safe.html','Legal & policies':'legal.html'};return `<a href="${map[a]||'#'}">${a}</a>`;}).join('')}</div>`).join('')}
    </div>
    ${payFooterHTML()}
    ...
    <div class="wrap" style="padding-bottom:32px;text-align:center;font-size:11px;color:var(--muted);line-height:1.5;opacity:.7">
      Currency conversions are indicative only, based on approximate exchange rates. No rights can be derived from displayed amounts in any currency.
    </div>
  </footer>`;
}
...
function injectGlobalSEO(){
  ...
  addJsonLd({
    ...
    "telephone":"+220 228 2717",
    "email":"info@mykunda.com",
    "address":{"@type":"PostalAddress","addressRegion":"West Coast Region","addressCountry":"GM"},
    "contactPoint":{"@type":"ContactPoint","contactType":"customer support","telephone":"+220 228 2717","email":"info@mykunda.com","availableLanguage":["English","Wolof","Mandinka"]},
...
function injectSEOBoilerplate(){
  ...
  if(!document.querySelector('meta[property="og:image"]')){
    const m=document.createElement('meta'); m.setAttribute('property','og:image'); m.setAttribute('content',SITE_URL+'/images/home-hero.webp'); document.head.appendChild(m);
  }
...
/* Standard fallback panel — WhatsApp, email and phone always work, even when a
   form doesn't. */
function contactFallbackHTML(waMsg, intro){
  ...
  return '<div style="margin-top:14px;padding:14px 16px;border-radius:12px;background:var(--amber-50);border:1px solid var(--amber-100);text-align:left">'
    ...
    + '<a class="btn btn-ghost btn-sm" href="tel:' + MYKUNDA_TEL + '">' + MYKUNDA_PHONE_DISPLAY + '</a>'
    + '</div></div>';
}
...
function initSEO(){ injectSEOBoilerplate(); injectGlobalSEO(); initCcyPicker(); initHdrSearch(); initMobileNav(); injectWhatsApp(); injectFaviconManifest(); injectCookieConsent(); detectAdmin(); warnPricingDrift(); }
...
function detectAdmin(){
  function rerenderHeader(){
    ...
    if(hdr && hdr.innerHTML){
      ...
      hdr.innerHTML=headerHTML('',wasHero);
...
/* ---------- Analytics (disabled — enable when a provider is chosen) ---------- */
function loadAnalytics(){ /* no-op for now */ }
