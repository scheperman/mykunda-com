...
(() => {
  ...
  function load() {
    ...
    /* De sidecar bestaat alleen in de ontwerpomgeving. Op de live site is er
       geen .image-slots.state.json, en de fetch leverde daar bij elke
       pageview een 404 in de console op (plus een overbodig verzoek).
       Zonder host is er niets te hydrateren: de foto's komen uit src=. */
    if (!(typeof window !== 'undefined' && window.omelette)) {
